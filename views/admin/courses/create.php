                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Добавление нового курса</small>
                        </h1>
            ...
            <?php endif; ?>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" class="form-control" placeholder="Введите название курса">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="price" class="form-control" placeholder="Введите цену">
                            </div>

                            <div class="form-group">
                                <label>Длительность курса</label>
                                <input name="timeline" class="form-control" placeholder="Введите длительность курса в часах">
                            </div>


                            <div class="form-group">
                                <label>Описание курса</label>
                                <textarea name="description"  id="description" class="form-control" rows="3" placeholder="Введите описание курса"></textarea>
                            </div>
