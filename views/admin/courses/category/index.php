...
?>
        ...
        <div id="page-wrapper" style="padding-bottom: 500px">
            ...
            <a href="/admin/courses/category/create" class="btn btn-default back"><i class="fa fa-plus"></i> Добавить новую категорию</a>
                        <h1 class="page-header">
                            <small>Просмотр всех категорий курсов</small>
                        </h1>
                    ...
                    <tr>
                        ...
                        <td><a href="/admin/courses/category/update/<?php echo $categoryItem['id']; ?>" title="Редактировать"><i class="fa fa-pencil-square-o"></i></a></td>
                        <td><a href="/admin/courses/category/delete/<?php echo $categoryItem['id']; ?>" title="Удалить"><i class="fa fa-times"></i></a></td>
                    </tr>
                <?php endforeach; ?>
