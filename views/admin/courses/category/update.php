                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Редактирование категории #<?php echo $id;?> - 
                        <?php echo $categoryItem['name'];?></small>
                        </h1>
            ...
            <?php endif; ?>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" class="form-control" placeholder="Введите название категории" value="<?php echo $categoryItem['name'] ?>">
                            </div>

                            <div class="form-group">
                                <label>Отображать №</label>
                                <input name="sort_order" class="form-control" placeholder="Введите № отображения категории" value="<?php echo $categoryItem['sort_order'] ?>">
                            </div>
