            ...
            <?php endif; ?>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" class="form-control" placeholder="Введите название новости" value="">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="3" placeholder="Введите краткое описание "></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="texts" class="form-control" rows="3" placeholder="Введите полное описание"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="users" class="form-control" placeholder="Введите автора новости" value="<?php if(isset($_SESSION['user'])) { 
