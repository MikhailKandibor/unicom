...
?>
        ...
        <div id="page-wrapper" style="padding-bottom: 500px">
            ...
            <a href="/admin/news/create" class="btn btn-default back"><i class="fa fa-plus"></i> Добавить новую новость</a>
            <a href="/admin/news/category" class="btn btn-default back"><i class="fa fa-list"></i> Управление категориями</a>
                        <h1 class="page-header">
                            <small>Просмотр всех новостей</small>
                        </h1>
                    ...
                    <tr>
                        ...
                        <td><?php echo $newsItem['users']; ?></td>   
                        <td><?php echo $newsItem['date']; ?></td>  
                        <td><?php echo $newsItem['status']; ?></td>  
                        <td><a href="/admin/news/update/<?php echo $newsItem['id']; ?>" title="Редактировать"><i class="fa fa-pencil-square-o"></i></a></td>
